...
class GlobalProviderController extends Controller
{
    ...
    public function export($type)
    {
       ...
       // Admins get all providers
        ...
        $info_sheet->setCellValue('B12', 'Required');
        $info_sheet->setCellValue('C12', 'Data Type');
        $info_sheet->setCellValue('D12', 'Description');
        $info_sheet->setCellValue('E12', 'Default');
        $info_sheet->setCellValue('A13', 'Id');
        $info_sheet->setCellValue('B13', 'Y');
        $info_sheet->setCellValue('C13', 'Integer');
        $info_sheet->setCellValue('D13', 'Unique CC-Plus Provider ID');
        $info_sheet->setCellValue('A14', 'Name');
        $info_sheet->setCellValue('B14', 'Y');
        $info_sheet->setCellValue('C14', 'String');
        $info_sheet->setCellValue('D14', 'Provider name');
        $info_sheet->setCellValue('A15', 'Active');
        $info_sheet->setCellValue('B15', 'N');
        $info_sheet->setCellValue('C15', 'String (Y or N)');
        $info_sheet->setCellValue('D15', 'Make the provider active?');
        $info_sheet->setCellValue('E15', 'Y');
        $info_sheet->setCellValue('A16', 'Server URL');
        $info_sheet->setCellValue('B16', 'Y');
        $info_sheet->setCellValue('C16', 'String');
        $info_sheet->setCellValue('D16', 'URL for Provider SUSHI service');
        $info_sheet->setCellValue('E16', 'NULL');
        $info_sheet->setCellValue('A17', 'harvest_day');
        $info_sheet->setCellValue('B17', 'N');
        $info_sheet->setCellValue('C17', 'Integer');
        $info_sheet->setCellValue('D17', 'Day of the month provider reports are ready (1-28)');
        $info_sheet->setCellValue('E17', '15');
        $info_sheet->setCellValue('A18', 'Institution ID');
        $info_sheet->setCellValue('B18', 'N');
        $info_sheet->setCellValue('C18', 'Integer');
        $info_sheet->setCellValue('D18', 'Institution ID (see above)');
        $info_sheet->setCellValue('E18', '1');
        $info_sheet->setCellValue('A19', 'PR Reports');
        $info_sheet->setCellValue('B19', 'N');
        $info_sheet->setCellValue('C19', 'String (Y or N)');
        $info_sheet->setCellValue('D19', 'Provider supplies PR reports?');
        $info_sheet->setCellValue('E19', 'Y');
        $info_sheet->setCellValue('A20', 'DR Reports');
        $info_sheet->setCellValue('B20', 'N');
        $info_sheet->setCellValue('C20', 'String (Y or N)');
        $info_sheet->setCellValue('D20', 'Provider supplies DR reports?');
        $info_sheet->setCellValue('E20', 'Y');
        $info_sheet->setCellValue('A21', 'TR Reports');
        $info_sheet->setCellValue('B21', 'N');
        $info_sheet->setCellValue('C21', 'String (Y or N)');
        $info_sheet->setCellValue('D21', 'Provider supplies TR reports?');
        $info_sheet->setCellValue('E21', 'Y');
        $info_sheet->setCellValue('A22', 'IR Reports');
        $info_sheet->setCellValue('B22', 'N');
        $info_sheet->setCellValue('C22', 'String (Y or N)');
        $info_sheet->setCellValue('D22', 'Provider supplies IR reports?');
        $info_sheet->setCellValue('E22', 'Y');
        $info_sheet->setCellValue('A23', 'Requestor ID');
        $info_sheet->setCellValue('B23', 'N');
        $info_sheet->setCellValue('C23', 'String (Y or N)');
        $info_sheet->setCellValue('D23', 'Requestor ID is required for Sushi connections');
        $info_sheet->setCellValue('E23', 'N');
        $info_sheet->setCellValue('A24', 'API Key');
        $info_sheet->setCellValue('B24', 'N');
        $info_sheet->setCellValue('C24', 'String (Y or N)');
        $info_sheet->setCellValue('D24', 'API Key is required for Sushi connections');
        $info_sheet->setCellValue('E24', 'N');
        $info_sheet->setCellValue('A25', 'Extra Arguments');
        $info_sheet->setCellValue('B25', 'N');
        $info_sheet->setCellValue('C25', 'String (Y or N)');
        $info_sheet->setCellValue('D25', 'Extra Arguments are required for Sushi connections');
        $info_sheet->setCellValue('E25', 'N');
        $info_sheet->setCellValue('A26', 'Extra Args Pattern');
        $info_sheet->setCellValue('B26', 'N');
        $info_sheet->setCellValue('C26', 'String');
        $info_sheet->setCellValue('D26', 'ExtraArgs Pattern - ignored if Extra Args is "N"');
        $info_sheet->setCellValue('E26', 'NULL');
        $info_sheet->setCellValue('D27', '(e.g.  &extra_cred=value&some_parm=value)');
