        ...
        if (DB::table($table)->get()->count() == 0) {
           ...
           // TR Report alertable fields
            DB::table($table)->insert(['id' => 17,'report_id' => 1, 'legend' => 'Total Item Investigations',
                'qry' => 'sum(total_item_investigations)', 'qry_as' => 'total_item_investigations',
                'reload' => 0]);
            DB::table($table)->insert(['id' => 18,'report_id' => 1, 'legend' => 'Total Item Requests',
                'qry' => 'sum(total_item_requests)', 'qry_as' => 'total_item_requests',
                'active' => 1, 'reload' => 0]);
            DB::table($table)->insert(['id' => 19,'report_id' => 1, 'legend' => 'Unique Item Investigations',
                'qry' => 'sum(unique_item_investigations)', 'qry_as' => 'unique_item_investigations',
                'reload' => 0]);
            DB::table($table)->insert(['id' => 20,'report_id' => 1, 'legend' => 'Unique Item Requests',
                'qry' => 'sum(unique_item_requests)', 'qry_as' => 'unique_item_requests', 'reload' => 0]);
            DB::table($table)->insert(['id' => 21,'report_id' => 1, 'legend' => 'Unique Title Investigations',
                'qry' => 'sum(unique_title_investigations)', 'qry_as' => 'unique_title_investigations',
                'reload' => 0]);
            DB::table($table)->insert(['id' => 22,'report_id' => 1, 'legend' => 'Unique Title Requests',
                'qry' => 'sum(unique_title_requests)', 'qry_as' => 'unique_title_requests', 'reload' => 0]);
            DB::table($table)->insert(['id' => 23,'report_id' => 1, 'legend' => 'Limit Exceeded',
                'qry' => 'sum(limit_exceeded)', 'qry_as' => 'limit_exceeded', 'reload' => 0]);
            DB::table($table)->insert(['id' => 24,'report_id' => 1, 'legend' => 'No License',
                'qry' => 'sum(no_license)', 'qry_as' => 'no_license', 'reload' => 0]);
           ...
           // DR Report alertable fields
            DB::table($table)->insert(['id' => 34,'report_id' => 2, 'legend' => 'Searches Automated',
                'qry' => 'sum(searches_automated)', 'qry_as' => 'searches_automated', 'reload' => 0]);
            DB::table($table)->insert(['id' => 35,'report_id' => 2, 'legend' => 'Searches Federated',
                'qry' => 'sum(searches_federated)', 'qry_as' => 'searches_federated', 'reload' => 0]);
            DB::table($table)->insert(['id' => 36,'report_id' => 2, 'legend' => 'Searches Regular',
                'qry' => 'sum(searches_regular)', 'qry_as' => 'searches_regular', 'active' => 1, 'reload' => 0]);
            DB::table($table)->insert(['id' => 37,'report_id' => 2, 'legend' => 'Total Item Investigations',
                'qry' => 'sum(total_item_investigations)', 'qry_as' => 'total_item_investigations', 'reload' => 0]);
            DB::table($table)->insert(['id' => 38,'report_id' => 2, 'legend' => 'Total Item Requests',
                'qry' => 'sum(total_item_requests)', 'qry_as' => 'total_item_requests', 'active' => 1, 'reload' => 0]);
            DB::table($table)->insert(['id' => 39,'report_id' => 2, 'legend' => 'Unique Item Investigations',
                'qry' => 'sum(unique_item_investigations)', 'qry_as' => 'unique_item_investigations', 'reload' => 0]);
            ...
            DB::table($table)->insert(['id' => 41,'report_id' => 2, 'legend' => 'Unique Title Investigations',
                'qry' => 'sum(unique_title_investigations)', 'qry_as' => 'unique_title_investigations', 'reload' => 0]);
           ...
           // PR Report alertable fields
            DB::table($table)->insert(['id' => 51, 'report_id' => 3, 'legend' => 'Searches Platform',
                'qry' => 'sum(searches_platform)', 'qry_as' => 'searches_platform', 'active' => 1, 'reload' => 0]);
            ...
            DB::table($table)->insert(['id' => 55, 'report_id' => 3, 'legend' => 'Unique Item Requests',
                'qry' => 'sum(unique_item_requests)', 'qry_as' => 'unique_item_requests', 'active' => 1,
                'reload' => 0]);
            ...
            DB::table($table)->insert(['id' => 57, 'report_id' => 3, 'legend' => 'Unique Title Requests',
                'qry' => 'sum(unique_title_requests)', 'qry_as' => 'unique_title_requests', 'active' => 1,
                'reload' => 0]);
