...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Creating A New Institution</h2>
        </div>
...
{!! Form::open(array('route' => 'institutions.store','method'=>'POST')) !!}
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>FTE:</strong>
            {!! Form::number('fte', null, array('min' => 0, 'class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('type_id', $types, null,
                            array('placeholder' => 'Assign a Type', 'class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Group Assignments:</strong>
            {!! Form::select('institutiongroups[]', $groups, null, array('class' => 'form-control','multiple')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
